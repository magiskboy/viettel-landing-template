...
export default function LandingContent() {
  return (
    <main className="min-h-screen flex flex-col pt-16">
      ...
      <Section id="services">
        <ViewportReveal direction="up" className="text-center mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <ViewportReveal direction="up" delay={0.2}>
              <Card 
                title="Viễn thông" 
          ...
          <ViewportReveal direction="up" delay={0.4}>
              <Card 
                title="Giải pháp Số" 
          ...
          <ViewportReveal direction="up" delay={0.6}>
              <Card 
      ...
      <Section bg="gray" className="relative overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <ViewportReveal direction="right" className="order-2 md:order-1">
             <div className="relative w-full h-80 overflow-hidden group">
                <img 
                    ...
                    alt="Technology Heart"
                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                />
             </div>
          </ViewportReveal>
          <ViewportReveal direction="left" className="order-1 md:order-2">
            ...
            <MagneticButton>Xem câu chuyện</MagneticButton>
          </ViewportReveal>
        </div>
      </Section>
      ...
      <Section>
        <ViewportReveal className="bg-viettel-red text-white p-12 text-center pointer-events-auto">
          <h2 className="text-2xl md:text-3xl font-bold mb-8">VIETTEL - THƯƠNG HIỆU GIÁ TRỊ NHẤT VIỆT NAM</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <ViewportReveal direction="up" delay={0.1}>
            ...
            <ViewportReveal direction="up" delay={0.3}>
      ...
      {/* SECTION 6: NEWS */}
      <Section bg="gray">
        <ViewportReveal direction="down" className="flex justify-between items-end mb-12">
            <div>
             ...
             <MagneticButton variant="outline" className="hidden md:flex">Xem tất cả</MagneticButton>
        </ViewportReveal>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <NewsCard 
      ...
      <Section id="contact">
        <ViewportReveal className="text-center mb-12">
